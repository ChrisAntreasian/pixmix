					...
					<div class="sidebar-block">
						...
						<div class="block-content">
						  ...
						  <p>PixMix took webcasting into consideration<br />
								when redesigning our two studios and<br />
								control room. We offer multiple phone<br />
								lines and shared data lines to<br />
								accommodate the needs of a webcast.</p>

								<p>For most webcasts we utilize our<br />
								high quality TV-1 Video Fiber Line<br />
								to transmit the TV signal to the<br />
								streaming service bureau.</p>

								<p>Live webcasts often include<br /> viewer interaction
								through the use<br /> of real time e-mail Q&amp;A.<br />
								The webcast team works at our<br />
