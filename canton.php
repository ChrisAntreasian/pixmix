...
<head>
    <title>PixMix - Canton Studio</title>
	...
	<div id="wrapper">
        ...
        <div id="main-content">
			<div class="content-left content-left--gallery">
                ...
                <div id="bigpic2"><img src="images/canton/pixmix-floorplan-canton.jpg" alt="AARP" />
                ...
                <div id="thumbs2">
                    <ul class="col-3">
                        <li>
                         ...
                         <li>
                            <a rel="images/canton/control-room.jpg" href="images/canton/control-room.jpg">
                                <img src="images/canton/control-room.jpg" alt="View of Control Room Front Bench" title="View of Control Room Front Bench" />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/talent-on-set.jpg" href="images/canton/talent-on-set.jpg">
                                <img src="images/canton/talent-on-set.jpg" alt="Doctors prepare for a LIVE - Labroots webcast " title="Doctors prepare for a LIVE - Labroots webcast " />
                            </a>
                        </li>
                    </ul>
                    <ul class="col-3">
                        <li>
                            <a rel="images/canton/single-talent-on-set.jpg" href="images/canton/single-talent-on-set.jpg">
                                <img src="images/canton/single-talent-on-set.jpg" alt="Talent prepares for a LIVE – Cmex webcast " title="Talent prepares for a LIVE – Cmex webcast " />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/web-cast.jpg" href="images/canton/web-cast.jpg">
                                <img src="images/canton/web-cast.jpg" alt="Actual ScreenShot from UBM / RAPID 7 webcast" title="Actual ScreenShot from UBM / RAPID 7 webcast" />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/webcast-desk.jpg" href="images/canton/webcast-desk.jpg">
                                <img src="images/canton/webcast-desk.jpg" alt="View of Studio Set from left side Camera 1 position" title="View of Studio Set from left side Camera 1 position" />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/pixmix-floorplan-canton.jpg" href="images/canton/pixmix-floorplan-canton.jpg">
                    ...
                    <ul class="col-3">
                        <li>
                            <a rel="images/canton/studio-set.jpg" href="images/canton/studio-set.jpg">
                                <img src="images/canton/studio-set.jpg" alt="View of Studio Set from center Camera 2 position" title="View of Studio Set from center Camera 2 position" />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/doctor-patient.jpg" href="images/canton/doctor-patient.jpg">
                                <img src="images/canton/doctor-patient.jpg" alt="Doctor and Patient prepare for an interview" title="Doctor and Patient prepare for an interview" />
                            </a>
                        </li>
                        <li>
                    ...
                    <ul class="col-3">
                        <li>
                            <a rel="images/canton/camera-left.jpg" href="images/canton/camera-left.jpg">
                                <img src="images/canton/camera-left.jpg" alt="Camera Left Shot of Set" title="Camera Left Shot of Set" />
                            </a>
                        </li>
                        <li>
                            <a rel="images/canton/camera-right.jpg" href="images/canton/camera-right.jpg">
                                <img src="images/canton/camera-right.jpg" alt="Camera Right Shot of Set" title="Camera Right Shot of Set" />
                            </a>
                        </li>
                        <li>
